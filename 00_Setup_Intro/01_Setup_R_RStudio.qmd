...
3.  **Install RTools:** RTools can be installed from the [CRAN website](https://cran.r-project.org/bin/windows/Rtools/). You need to install the version corresponding to the R version you have installed through its installer.
4.  **Install Quarto:** Go to [Quarto's website](https://quarto.org/docs/get-started/) and download and install Quarto for your system. RStudio often bundles Quarto, but installing the latest version is good practice.
