# Module 3.2: Data Quality Control and Filtering for SNP Data
...
matrix <- read.table(here("data", "BarleyMatrix.txt"), sep = "\t", header = TRUE, 
...
markers <- read.table(here("data","BarleyMarkers.tsv"), sep = "\t", header = TRUE, 
                     check.names = FALSE)
```
